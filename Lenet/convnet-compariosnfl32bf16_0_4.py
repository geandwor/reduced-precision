...
convnet-comparisnfl32bf160_4, the bfloat16 calculation will be expanded to the first fc layer
"""
...
b_fc2dif = tf.reduce_mean(tf.sqrt(tf.square(tf.subtract(bfl32_fc2,bbf16_fl32_fc2))))
...
plt.legend()
plt.savefig("/home/uic-cs/Desktop/summerIntern/accuracy_fl32bf16convoluted_more_iterationssetup0_4.png")
plt.show()
...
def graphTwo(bf16list,fl32list,ylabel,xlabel,title):
    ...
    plt.ylabel(ylabel)
    plt.legend()
    plt.savefig("/home/uic-cs/Desktop/summerIntern/"+title+".png")
    plt.show()
