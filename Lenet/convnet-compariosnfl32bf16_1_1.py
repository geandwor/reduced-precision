...
all the parameters used with bf16 are declared in bf16 except the first convoluted layer in fl32 and then cast to bf16 
...
plt.legend()
plt.savefig("/home/uic-cs/Desktop/summerIntern/accuracy_fl32bf16convoluted_more_iterationssetup1_1.png")
plt.show()
