...
all the parameters used with bf16 are declared in bfl6
...
Wbf16_conv1 = weight_variablebf16([5,5,1,32])
bbf16_conv1 = bias_variablebf16([32])
...
hbf16_conv1 = tf.nn.relu(conv2d(xbf16_image,Wbf16_conv1)+bbf16_conv1)
...
hbf16_conv2 = tf.nn.relu(conv2d(hbf16_pool1,Wbf16_conv2)+bbf16_conv2)
...
#cast hbd16_fc1 to float32 for nn.dropout
...
#cast last layer output to float32 for the softmax
...
plt.legend()
plt.savefig("/home/uic-cs/Desktop/summerIntern/accuracy_fl32bf16convoluted_more_iterations.png")
plt.show()
