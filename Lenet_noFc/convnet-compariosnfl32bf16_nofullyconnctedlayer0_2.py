...
@author: uic-cs
extension from convnet-comparisnfl32bf160_1, which has only the input X and label are defined in bf16, then cast float32, in the first conv layer, all the calculations are in bf16 except the conv2d
all the other calculations are done in float32,
convnet-comparisnfl32bf160_2, the bfloat16 calculation will be expanded to the second convlayers
"""
...
ybf16_fl32_conv = tf.matmul(hbf16_fl32_pool2_flat_drop,Wbf16_fc1)+bbf16_fc1
...
#plot the differentce of entropy of fl32 and bf16
import numpy as np
...
plt.legend()
plt.savefig("/home/uic-cs/Desktop/summerIntern/accuracy_fl32bf16convoluted_more_iterationssetup0_2.png")
plt.show()
