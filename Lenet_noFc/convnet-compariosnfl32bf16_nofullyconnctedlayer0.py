...
only the input X and label are defind in bf16, then cast float32, all the calculations are done in float32
"""
...
plt.legend()
plt.savefig("/home/uic-cs/Desktop/summerIntern/accuracy_fl32bf16nofc_setup0.png")
plt.show()
